...
var MIB = function (dir) {
    ...
    var newMIB = ({
        ...
        Import: function (MibName, MibData) { // brfs require this in static mode
            // FileData = fs.readFileSync(FileName).toString()
            // FileName = FileName.split('/')[FileName.split('/').length - 1].split('.')[0]
            this.ParseModule(MibName, MibData);
        },
